...
public class G4Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g4story);
        ...
        Intent next = new Intent(G4Story.this, G5Story.class);
        ...
        if (b1 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G9Story.class);
                startActivity(i);
            });
        }
        if (b2 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G10Story.class);
                startActivity(i);
            });
        }
        if (b3 != null) {
            b3.setOnClickListener(v -> {                               // zu G5
                Intent i = new Intent(this, G11Story.class);
                startActivity(i);
            });
        }
    }
