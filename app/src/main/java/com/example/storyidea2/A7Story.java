...
public class A7Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a7activity_sixth);
        ...
        Intent next = new Intent(A7Story.this, A8Story.class);
        ...
        if (b2 != null) {
            b2.setOnClickListener(v -> {
                Intent deathIntent = new Intent(this, X9Death.class);
