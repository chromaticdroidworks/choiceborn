...
public class A12Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a12activity_eleventh);
        ...
        // Alle 3 Buttons -> A13Story (außer b2 -> X3Death)
        Intent next = new Intent(A12Story.this, A13Story.class);
        ...
        if (b2 != null) {
            b2.setOnClickListener(v -> {
                Intent deathIntent = new Intent(this, X3Death.class);
