...
public class G3Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g3story);
        ...
        Intent next = new Intent(G3Story.this, G4Story.class);
        ...
        if (b1 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, XG1Death.class);
                startActivity(i);
            });
        }
        if (b2 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G7Story.class);
                startActivity(i);
            });
        }
        if (b3 != null) {
