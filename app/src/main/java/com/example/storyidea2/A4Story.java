...
public class A4Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a4activity_third);
        ...
        // Alle 3 Buttons -> A5Story
        Intent next = new Intent(A4Story.this, A5Story.class);

        Button b1 = findViewById(R.id.btnOne);
        Button b2 = findViewById(R.id.btnTwo);
        Button b3 = findViewById(R.id.btnThree);

        if (b1 != null) b1.setOnClickListener(v -> startActivity(next));
        if (b2 != null) b2.setOnClickListener(v -> startActivity(next));
        if (b3 != null) b3.setOnClickListener(v -> startActivity(next));
    }

    // Popup-Menü mit "Neue Geschichte" und "Einstellungen"
