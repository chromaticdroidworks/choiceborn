...
public class G7Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g7story);
        ...
        Intent next = new Intent(G7Story.this, G8Story.class);
        ...
        if (b1 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G15Story.class);
                startActivity(i);
            });
        }
        if (b2 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G16Story.class);
                startActivity(i);
            });
        }
        if (b3 != null) {
            b3.setOnClickListener(v -> {                               // zu G5
                Intent i = new Intent(this, XG2Death.class);
                startActivity(i);
            });
        }
    }
