...
public class A25Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a25activity_twentyfourth);
        ...
        Intent next = new Intent(A25Story.this, A26Story.class);
        ...
        if (b2 != null) {
            b2.setOnClickListener(v -> {
                Intent deathIntent = new Intent(this, X7Death.class);
