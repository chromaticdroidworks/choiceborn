...
public class G5Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g5story);
        ...
        Intent next = new Intent(G5Story.this, G6Story.class);
        ...
        if (b1 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G12Story.class);
                startActivity(i);
            });
        }
        if (b2 != null) {
            b2.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G13Story.class);
                startActivity(i);
            });
        }
        if (b3 != null) {
            b3.setOnClickListener(v -> {                               // zu G5
                Intent i = new Intent(this, G14Story.class);
                startActivity(i);
            });
        }
    }
