...
public class A37Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a37activity_thirtysixth);
        ...
        Intent next = new Intent(com.example.storyidea2.A37Story.this, A38Story.class);
