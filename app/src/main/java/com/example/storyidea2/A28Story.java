...
public class A28Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a28activity_twentyseventh);
        ...
        Intent next = new Intent(A28Story.this, A29Story.class);
        ...
        if (b2 != null) {
            b2.setOnClickListener(v -> startActivity(next));
        }
        if (b3 != null) {
