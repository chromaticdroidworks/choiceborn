...
public class G9Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g9story);
        ...
        Intent next = new Intent(G9Story.this, G10Story.class);

        Button b1 = findViewById(R.id.btnOne);
        if (b1 != null) {
            b1.setOnClickListener(v -> {                               // zu G4
                Intent i = new Intent(this, G25Story.class);
                startActivity(i);
            });
        }
    }
