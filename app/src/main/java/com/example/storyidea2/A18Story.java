...
public class A18Story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a18activity_seventeenth);
        ...
        // Alle 3 Buttons -> A4ThirdActivityS
        Intent next = new Intent(A18Story.this, A19Story.class);
        ...
        if (b2 != null) {
            b2.setOnClickListener(v -> {
                Intent deathIntent = new Intent(this, X5Death.class);
